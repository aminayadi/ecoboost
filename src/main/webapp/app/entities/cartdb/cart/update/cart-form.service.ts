...
type CartFormGroupContent = {
  ...
  globalQuantity: FormControl<ICart['globalQuantity']>;
  codeProduct: FormControl<ICart['codeProduct']>;
  quantity: FormControl<ICart['quantity']>;
  lastestModif: FormControl<ICart['lastestModif']>;
};
...
export class CartFormService {
  createCartFormGroup(cart: CartFormGroupInput = { id: null }): CartFormGroup {
    ...
    return new FormGroup<CartFormGroupContent>({
      ...
      globalQuantity: new FormControl(cartRawValue.globalQuantity),
      codeProduct: new FormControl(cartRawValue.codeProduct),
      quantity: new FormControl(cartRawValue.quantity),
      lastestModif: new FormControl(cartRawValue.lastestModif),
    });
  }
