...
describe('UserExtra Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 'bbfa1bd3-2d04-461b-96bb-3a3afde2701f' };
      userExtra.user = user;

      const userCollection: IUser[] = [{ id: 'abece48b-d1b1-446b-94ad-b0a787ffddeb' }];
    ...
    it('Should update editForm', () => {
      const userExtra: IUserExtra = { id: 'CBA' };
      const user: IUser = { id: 'e7ab0a33-1297-43a6-b2a5-5cdd89a7d363' };
      userExtra.user = user;
