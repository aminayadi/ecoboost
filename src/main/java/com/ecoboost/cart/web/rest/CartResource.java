...
import com.ecoboost.cart.service.CartService;
import com.ecoboost.cart.service.dto.CartDTO;
import com.ecoboost.cart.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ecoboost.cart.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
public class CartResource {
    ...
    private static final String ENTITY_NAME = "cartdbCart";
