package com.ecoboost.gateway;

import com.ecoboost.gateway.GatewaydbApp;
import com.ecoboost.gateway.config.AsyncSyncConfiguration;
import com.ecoboost.gateway.config.EmbeddedMongo;
...
@SpringBootTest(classes = { GatewaydbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
